...
This project implements a framework for **drug–drug interaction (DDI) prediction**, combining **edge-aware graph learning** with **Hop2Token molecular representations**.  
