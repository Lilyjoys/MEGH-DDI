...
**Edge-aware Graph Learning with Hop2Token Representations**

This project provides a framework for **drug–drug interaction (DDI) prediction**, integrating **edge-aware graph learning** and **Hop2Token molecular representations**.  
It supports **DrugBank** and **Miner** datasets in both **inductive** and **transductive** settings, with ready-to-run training scripts.
